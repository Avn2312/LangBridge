...
userSchema.index({ isOnboarded: 1, nativeLanguage: 1, learningLanguage: 1 });
userSchema.index({ isOnboarded: 1, learningLanguage: 1, nativeLanguage: 1 });
userSchema.index({ isOnboarded: 1, updatedAt: -1, _id: -1 });
